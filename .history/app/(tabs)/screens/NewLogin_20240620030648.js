...
const NewLogin = () => {
  ...
  const renderVideo = () => {
    if (Platform.OS === "web") {
      ...
      return (
        <video src="https://www.youtube.com/watch?v=TIPF5EmOH6k" autoPlay={true} loop width={"100%"} height={300} controls>
          <source src="https://www.youtube.com/watch?v=TIPF5EmOH6k" type="video/mp4" />
